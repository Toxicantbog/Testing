...
public class DrivetrainSubsystem extends SubsystemBase {
    ...
    public static final double MAX_ACCELERATION_METERS_PER_SECOND = 2.0;
    public static final double MAX_VELOCITY_METERS_PER_SECOND = 4.14528;
    public static final double MAX_ANGULAR_VELOCITY_RADIANS_PER_SECOND = MAX_VELOCITY_METERS_PER_SECOND /
            Math.hypot(Constants.DRIVETRAIN_TRACKWIDTH_METERS / 2.0, Constants.DRIVETRAIN_WHEELBASE_METERS / 2.0);

    // This initialization creates a custom configuration that allows us to set the
    // steer and drive limits for the motors. We then feed the configuration into the swerve
    // drive when making it later.
